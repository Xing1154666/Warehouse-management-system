				...
				$.ajax({
					...
					success: function (data) {
						$.each(data.data.goods,function (i,n){
							...
							html+='<th width="10%" class="tablebody1" align="center"><a  style="color: red" href="InOldStock.jsp?name='+n.name+"&num="+n.num+"&unitPrice="+n.unitPrice+"&sort="+n.sort+"&price="+n.price+'">入库</a> </th>'
							html+='</tr>';
							$("#inGoods").append(html);
						})
